...
class PaperBook(Book):
    ...
    def __str__(self):
        return f"Книга {self.get_name()}. Автор {self.get_author()}. Количество страниц: {self.get_pages()}"
...
class AudioBook(Book):
    ...
    def __str__(self):
        return f"Книга {self.get_name()}. Автор {self.get_author()}. Продолжительность: {self.get_duration()} часов"
